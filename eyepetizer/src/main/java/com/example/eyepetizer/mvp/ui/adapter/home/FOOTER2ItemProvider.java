...
public class FOOTER2ItemProvider extends BaseItemProvider<ItemListBean> {
    @Override
    ...
    public int getLayoutId() {
        return R.layout.adapter_item_footer2;
    }

    @Override
    public void convert(@NotNull BaseViewHolder holder, @Nullable ItemListBean data) {
        holder.setText(R.id.tv_footer2, data.getData().getText());
    }
}
