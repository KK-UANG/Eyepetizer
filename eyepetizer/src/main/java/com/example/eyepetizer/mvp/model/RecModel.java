 ...
 */
@FragmentScope
public class RecModel extends BaseModel implements RecContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public RecModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<DataBean> getRecData(String url) {
